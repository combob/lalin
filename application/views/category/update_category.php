            ...
            <div class="large-8 columns??">
                <div class="row top30">
                  ...
                  <div class="large-8 columns name-field">
                      <input type="text" name="category_name" placeholder="Category Name" value="<?php echo $result->category_name;?>" required>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="large-8 columns name-field">
                      <input type="text" name="alias" placeholder="alias" value="<?php echo $result->alias;?>" required />
                  </div>
                </div>
                ...
                <div class="row top10">
                  ...
                  <div class="large-8 columns name-field">
                      <textarea rows="8" name="description" placeholder="Description" required><?php echo $result->description;?></textarea>
                          </div>
                </div>

				<?php echo form_hidden('cate_id', $result->cate_id);?>
                <div class="row">
                  <div class="large-4 columns">

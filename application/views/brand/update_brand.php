    ...
    <div class="row bottom70">
		<div class="large-12 columns top20">
			<div class="dashboard-noborder">
				<?php echo form_open_multipart('brands/do_edit', array('id' => 'fromedit'));?>
						...
						<div class="large-8 columns??">
							<div class="row top30">
								...
								<div class="large-8 columns name-field">
									<input type="text" name="brand_name" placeholder="Brand Name" value="<?php echo $result->brand_name;?>" required>
								</div>
							</div>
